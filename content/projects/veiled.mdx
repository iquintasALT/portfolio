...
title: "Veiled"
image: "/media/projects/veiled.mp4"
libraries:
  - Videogame
...
> **⚠️ Warning:** WORK IN PROGRESS. For now, it loads its github readme

![Veiled](https://aarmor01.github.io/Veiled/assets/media/headers/h_title_bg.png)

<center>
  <a href="https://aarmor01.github.io/Veiled/">
    <img src="https://aarmor01.github.io/Veiled/assets/media/controller.png" alt="Game" width="100" height="100" />
  </a>
</center>

![Descripción](https://aarmor01.github.io/Veiled/assets/media/headers/h_descripcion.png)
...
![Mecánicas](https://aarmor01.github.io/Veiled/assets/media/headers/h_mecanicas.png)
...
![Cordura](https://aarmor01.github.io/Veiled/assets/media/features/sanity.gif)
...
![Veiledsss](https://aarmor01.github.io/Veiled/assets/media/features/npc.gif)
...
![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/ghost.gif)
...
![Dinámicas](https://aarmor01.github.io/Veiled/assets/media/headers/h_dinamicas.png)
...
![Contenido](https://aarmor01.github.io/Veiled/assets/media/headers/h_contenido.png)
...
- Durante el **Epílogo** y tras completar la línea de eventos principal en el pueblo, el jugador podrá desbloquear la posibilidad de hablar con su abuela que le entregara una carta de su padre. El video final del juego donde se ve el contenido de la carta se puede consultar en este mismo [repositorio](https://github.com/aarmor01/Veiled/blob/main/assets/media/ending.mp4).

![pueblo](https://aarmor01.github.io/Veiled/assets/media/level_01.png)
...
![Evento de texto](https://aarmor01.github.io/Veiled/assets/media/features/text_event.gif)
...
| --------------------------------------------------------------------------------- | ------ | -------------------------------------------------------- |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/dad.gif) | Padre  | Sirve de tutorial principal e introducción a la historia |

#### PUEBLO

| Sprite                                                                                   | Nombre     | Evento                                                                                              |
| ---------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------- |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/brother.gif)    | Hermano    | Progresa la línea principal                                                                         |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/kid.gif)        | Niño       | Te cambia una flor por un poco de comida                                                            |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/doctor.gif)     | Doctor     | Progresa la línea principal                                                                         |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/glasses.gif)    | Ayudante   | Le puedes ayudar a encontrar sus gafas                                                              |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/elder.gif)      | Abuela     | Progresa la línea principal                                                                         |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/fisherman.gif)  | Anciano    | Recuerda mecánicas básicas al principio del nivel y apunta al jugador a distintas partes del pueblo |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/foreigner.gif)  | Extranjera | Te da una bolsa de monedas a cambio de ayuda                                                        |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/lumberjack.gif) | Leñador    | Te manda a buscar un árbol enfermo                                                                  |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/painter.gif)    | Pintora    | Puedes opinar sobre su obra                                                                         |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/seller.gif)     | Vendedor   | Intercambia objetos consumibles por bolsas de monedas                                               |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/tavern.gif)     | Tavernero  | Te manda a buscar un bastón para poder avanzar la trama principal                                   |
| ![alt text](https://aarmor01.github.io/Veiled/assets/media/features/npcs/vagabond.gif)   | Vagabundo  | Parte del evento del doctor                                                                         |
...
| ------------------------------------------------------------------------------------ | -------- | ------------------------------------------ |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_photo.png)   | Foto     | Permite continuar el tutorial del preludio |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_pendant.png) | Colgante | Aumenta la fe (+60)                        |

- **CLAVE**

| Sprite                                                                                   | Nombre            | Utilidad                                              |
| ---------------------------------------------------------------------------------------- | ----------------- | ----------------------------------------------------- |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_avoiddeath.png)  | Figura tallada    | Te permite sobrevivir al evento de muerte             |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_baston.png)      | Baston            | Permite terminar el evento del vagabundo              |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_booze.png)       | Botella           | Permite terminar el evento de anciano                 |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_emptybucket.png) | Cubo vacío        | Permite iniciar el evento del pozo                    |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_waterbucket.png) | Cubo con agua     | Permite terminar el evento del pozo                   |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_flower.png)      | Flor              | Permite terminar el evento del cementerio             |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_food.png)        | Comida            | Permite terminar el evento del niño                   |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_glasses.png)     | Gafas             | Necesario para completar el evento del ayudante       |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_sketch.png)      | Boceto            | Utilizado durante el evento de la pintora             |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_moneybag.png)    | Bolsa con monedas | Permite comprar un consumible al vendedor de la plaza |

- **CONSUMIBLES**

| Sprite                                                                                    | Nombre        | Utilidad                                                                |
| ----------------------------------------------------------------------------------------- | ------------- | ----------------------------------------------------------------------- |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_potion.png)       | Poción        | Recupera cordura (+30)                                                  |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_kaleidoscope.png) | Caleidoscopio | Reduce el gasto de cordura con la venda quitada (50%)                   |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_stamp.png)        | Estampita     | Aumenta la fe (+10)                                                     |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_blessing.png)     | Bendición     | Aumenta bastante la fe (+30)                                            |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_blindfold.png)    | Venda de tela | Aumenta la cordura máxima (+30)                                         |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_sacredfire.png)   | Fuego sagrado | Tu cordura maxima disminuye (-30), pero aumenta bastante tu fe          |
| ![alt text](https://aarmor01.github.io/Veiled/assets/sprites/items/item_lessdeath.png)    | Láudano       | Menos probabiblidad de morir durante la opción RNG del evento de muerte |

![Estética](https://aarmor01.github.io/Veiled/assets/media/headers/h_estetica.png)
...
![Controles](https://aarmor01.github.io/Veiled/assets/media/headers/h_controles.png)
...
![Keybinds](https://aarmor01.github.io/Veiled/assets/media/keybinds_gdd.png)

![Interfaz y Menús](https://aarmor01.github.io/Veiled/assets/media/headers/h_interfaz.png)
...
![Inventario](https://aarmor01.github.io/Veiled/assets/media/features/inventory.gif)

![API](https://aarmor01.github.io/Veiled/assets/media/headers/h_arquitectura.png)

![Game API](https://aarmor01.github.io/Veiled/assets/media/game_API.png)

![Referencias](https://aarmor01.github.io/Veiled/assets/media/headers/h_referencias.png)

- _La venda, Miguel de Unamuno, 1899. (Temática principal)_
- _Zelda: Link's Awakening (mundo)_
- _Stardew Valley (mapa en cuanto a distribución y apariencia)_
- _Perception (Mecánica de visión)_
- _Lego Games (Fe)_
- _La Voluntad – Azorín (Barra de Cordura)_

<a href="https://www.pivotaltracker.com/n/projects/2467983">
  <img
    src="https://aarmor01.github.io/Veiled/assets/media/pivotal_tracker.png"
    alt="Pivotal"
    width="25"
    height="25"
    align="right"
