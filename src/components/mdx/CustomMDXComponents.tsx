...
function CustomMDXComponents(): MDXComponents {
  return {
    ...
    h3: (props) => <h3 className="text-2xl font-semibold text-foreground mb-3 mt-8" {...props} />,
    ul: (props) => <ul className="list-disc pl-6 space-y-2 text-lg text-foreground/90" {...props} />,
    ol: (props) => <ol className="list-decimal pl-6 space-y-2 text-lg text-foreground/90" {...props} />,
    ...
    pre: (props) => (
      <pre
        className="bg-zinc-900 text-primary-foreground p-4 rounded-xl my-6 overflow-x-auto border border-border shadow-lg"
        {...props}
      />
    ),
    p: (props) => <p className="text-lg text-foreground/90 my-4 leading-relaxed" {...props} />,
    a: (props) => (
      <a
